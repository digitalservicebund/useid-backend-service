...
[![Secrets Check](https://github.com/digitalservice4germany/eid-qrcode-service/actions/workflows/secrets-check.yml/badge.svg)](https://github.com/digitalservice4germany/eid-qrcode-service/actions/workflows/secrets-check.yml)
...
Go
to [https://sonarcloud.io](https://sonarcloud.io/dashboard?id=digitalservice4germany_eid-qrcode-service)
for the results.
...
```bash
docker run -p8080:8080 "ghcr.io/digitalservice4germany/eid-qrcode-service:$(git log -1 origin/main --format='%H')"
```
...
docker run -p8080:8080 ghcr.io/digitalservice4germany/eid-qrcode-service
```
...
```bash
COSIGN_EXPERIMENTAL=1 cosign verify "ghcr.io/digitalservice4germany/eid-qrcode-service:$(git log -1 origin/main --format='%H')"
```
...
export CONTAINER_IMAGE_NAME=digitalservice4germany/eid-qrcode-service
...
docker push "ghcr.io/digitalservice4germany/eid-qrcode-service:$(git log -1 --format='%H')"
```
...
```bash
./gradlew bootBuildImage
trivy image --severity HIGH,CRITICAL ghcr.io/digitalservice4germany/eid-qrcode-service:latest
```
