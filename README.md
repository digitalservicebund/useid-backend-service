...
[![Pipeline](https://github.com/digitalservice4germany/useid-backend-service/actions/workflows/pipeline.yml/badge.svg)](https://github.com/digitalservice4germany/useid-backend-service/actions/workflows/pipeline.yml)
[![Scan](https://github.com/digitalservice4germany/useid-backend-service/actions/workflows/scan.yml/badge.svg)](https://github.com/digitalservice4germany/useid-backend-service/actions/workflows/scan.yml)
[![Secrets Check](https://github.com/digitalservice4germany/useid-backend-service/actions/workflows/secrets-check.yml/badge.svg)](https://github.com/digitalservice4germany/useid-backend-service/actions/workflows/secrets-check.yml)
...
```bash
docker run -p8080:8080 "ghcr.io/digitalservice4germany/useid-backend-service:$(git log -1 origin/main --format='%H')"
```
...
docker run -p8080:8080 ghcr.io/digitalservice4germany/useid-backend-service
```
...
```bash
COSIGN_EXPERIMENTAL=1 cosign verify "ghcr.io/digitalservice4germany/useid-backend-service:$(git log -1 origin/main --format='%H')"
```
...
export CONTAINER_IMAGE_NAME=digitalservice4germany/useid-backend-service
...
docker push "ghcr.io/digitalservice4germany/useid-backend-service:$(git log -1 --format='%H')"
```
...
```bash
./gradlew bootBuildImage
trivy image --severity HIGH,CRITICAL ghcr.io/digitalservice4germany/useid-backend-service:latest
```
